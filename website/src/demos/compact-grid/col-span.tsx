...
const spanFieldClassName = 'space-y-2 rounded-md border border-dashed border-primary/40 bg-accent/30 p-3';
      ...
      <div className="space-y-6 p-6">
        <div className="flex flex-wrap gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="compact-col-span-show-amount-slot">金额插槽</Label>
          </div>
        ...
        >
          <div className={fieldClassName}>
            ...
            <Input id="compact-col-span-customer" placeholder="输入客户名称" />
          </div>
          ...
          {showAddress && (
            <CompactGrid.Item colSpan={2} className={spanFieldClassName}>
              <Label htmlFor="compact-col-span-address">联系地址</Label>
              <Input id="compact-col-span-address" placeholder="跨 2 列显示" />
            </CompactGrid.Item>
          )}
          ...
          {showNote && (
            <CompactGrid.Item colSpan="full" className={spanFieldClassName}>
              ...
              <div className="flex gap-2">
                <Input id="compact-col-span-note" placeholder="占满当前行显示" />
          ...
          {showPriority && (
            <div className={fieldClassName}>
              ...
              <Select defaultValue="medium">
                <SelectTrigger id="compact-col-span-priority" className="w-full">
